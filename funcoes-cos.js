...
ang = document.getElementById("angulo").value; //lê o ãngulo em graus 
...
n = document.getElementById("nvezes").value; //lê o numero de termos do polinomio
...
fat=1;
for (c = num; c >= 1; c--) { // para c de um num a 1 , subtraindo de 1 em 1
fat=fat*c;
}
return fat
}
